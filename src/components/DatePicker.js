...
import { CalendarMonthOutline, Close } from 'mdi-material-ui';
      ...
      InputProps={{
        startAdornment: (
          <InputAdornment position="start">
            <CalendarMonthOutline sx={{ color: 'primary.main' }} />
          </InputAdornment>
        ),
        endAdornment: !!props?.onClear && (
          <InputAdornment position="end">
            <IconButton onClick={props?.onClear} sx={{ mr: -1 }}>
              <Close sx={{ color: 'gray', fontSize: 20 }} />
            </IconButton>
          </InputAdornment>
        ),
