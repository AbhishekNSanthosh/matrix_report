...
// import { generalApoloClient } from 'src/configs/apolloClient';
...
import { ADD_EQUIPEMENT } from '@/graphql/equipements';
...
const AddEquipement = ({ languages = [] }) => {
  ...
  const onSubmit = async (params) => {
    ...
    try {
      ...
      if (data?.createEquipement) {
        toast.success('New Equipement Created!');
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Card>
          <CardHeader title="Add New Equipement" titleTypographyProps={{ variant: 'h6' }} />
          <Divider sx={{ m: 0 }} />
